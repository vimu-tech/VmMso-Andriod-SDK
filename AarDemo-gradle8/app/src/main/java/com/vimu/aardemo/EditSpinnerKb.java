...
public class EditSpinnerKb extends EditSpinner {

    ArrayAdapter<String> spinnerAdapter;
    String[] spinnerStrings = new String[]{"K"};

    public EditSpinnerKb(Context context) {
        super(context);
        init(context);
    }

    public EditSpinnerKb(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public EditSpinnerKb(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public EditSpinnerKb(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
